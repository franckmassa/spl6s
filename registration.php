    ...
    <div class="container managment mt-5 text-white">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <a class="text-white" href="index.php"><img class="mt-3" src="assets/img/logoFondBleu.png" alt="logo site" width="190" id="logo" /><i class="fas fa-home"></i></a> 
            </div>
        </div>
        <h1 class="mt-5 text-center">Enregistrement</h1>
        ...
        <form action="#" method="post">
            ...
            <div class="form-row">
                ...
                <button type="submit" name="submit" class="mb-5">Je m'enregistre</button>
            </div> 
        </form>
    </div>
</body>
